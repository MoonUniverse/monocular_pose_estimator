...
#ifndef STARGAZERIMGTYPES_H_
#define STARGAZERIMGTYPES_H_
...
/**
 * @brief A cluster is an unordered collection of points, it represents a
 * hypothesis for a landmark.
 *
 */
typedef std::vector<cv::Point> Cluster;

/**
 * @brief An image landmark holds the information of a observed landmark. All
