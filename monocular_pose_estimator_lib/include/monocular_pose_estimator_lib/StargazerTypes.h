...
/**
 * @brief Definition of the six pose parameters. The rotation angles are given
 * as rodriguez angles
 *
 */
...
/**
 * @brief   A point is a 3D translation-only position. See ::POINT for the
 * indexing scheme.
 *
 */
typedef std::array<double, (int)POINT::N_PARAMS> Point;
/**
 * @brief   This object hold the camera parameters. See ::INTRINSICS for the
 * indexing scheme.
 */
...
struct Landmark {
  ...
  std::vector<Point>
      points; /**< Vector of landmark points. The first three are the corners */
  static constexpr int kGridCount =
      4; /**< Defines how many rows and columns the landmark has */
  static constexpr double kGridDistance =
      0.04; /**< Defines the distance between two landmark LEDs in meters. This
...
/**
 * @brief This class resembles the map representation. It hold a map of all
 * known landmarks.
 *
 */
